...
import static org.osgi.jmx.core.BundleStateMBean.BUNDLE_LOCATION;
import static org.osgi.jmx.core.BundleStateMBean.BUNDLE_SYMBOLIC_NAME;
import static org.osgi.jmx.core.BundleStateMBean.EVENT_TYPE;
...
/**
 * @author Hal Hildebrand Date: Nov 24, 2008 Time: 2:22:34 PM
 *         <p>
 *         This class represents the CODEC for the composite data representing a
 *         OSGi <link>BundleEvent</link>
 *         <p>
    ...
    public CompositeData asCompositeData() {
        ...
        try {
            ...
            throw new IllegalStateException(
                                            "Cannot form bundle event open data",
                                            e);
        }
    }
