...
import static org.osgi.jmx.codec.Util.longArrayFrom;
import static org.osgi.jmx.core.PackageStateMBean.PACKAGE_NAME;
import static org.osgi.jmx.core.PackageStateMBean.PACKAGE_VERSION;
import static org.osgi.jmx.core.PackageStateMBean.BUNDLE_IDENTIFIER;
...
/**
 * @author Hal Hildebrand Date: Nov 24, 2008 Time: 6:48:30 AM
 *         <p>
 *         This class represents the CODEC for the composite data representing
 *         an OSGi <link>ExportedPackage</link>
 *         <p>
...
public class OSGiPackage {
    ...
    public OSGiPackage(CompositeData data) {
        this(
             (String) data.get(PackageStateMBean.PACKAGE_NAME),
             (String) data.get(PackageStateMBean.PACKAGE_VERSION),
             (Boolean) data.get(PackageStateMBean.PACKAGE_PENDING_REMOVAL),
             (Long) data.get(PackageStateMBean.BUNDLE_IDENTIFIER),
