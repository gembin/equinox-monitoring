...
/**
 * @author Hal Hildebrand Date: Nov 24, 2008 Time: 7:05:14 AM
 *         <p>
 *         This class represents the CODEC for the composite data representing
 *         an OSGi <link>ServiceReference</link>
 *         <p>
...
public class OSGiService {
    ...
    public OSGiService(CompositeData data) {
        this((Long) data.get(ServiceStateMBean.SERVICE_ID),
    ...
    private static TabularType createServiceTableType() {
        try {
            return new TabularType(
                                   ...
                                   SERVICE,
                                   new String[] { ServiceStateMBean.SERVICE_ID });
